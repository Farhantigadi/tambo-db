  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800/50 rounded-lg shadow-md border dark:border-white/10 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-white">{safeStats.totalContacts}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800/50 rounded-lg shadow-md border dark:border-white/10 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-white">{safeStats.activeContacts}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800/50 rounded-lg shadow-md border dark:border-white/10 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-white">{safeStats.prospects}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800/50 rounded-lg shadow-md border dark:border-white/10 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-white">{safeStats.customers}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800/50 rounded-lg shadow-md border dark:border-white/10 p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-blue-600 dark:text-blue-400">{safeStats.pendingTasks}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-gray-400">Overdue Tasks</span>
              <span className="font-semibold text-red-600 dark:text-red-400">{safeStats.overdueTasks}</span>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-3">
              {topCompanies.slice(0, 5).map((company) => (
                <div key={company.company} className="flex justify-between items-center">
                  <span className="text-gray-600 dark:text-gray-400">{company.company}</span>
                  <span className="font-semibold text-gray-900 dark:text-white">{company.count}</span>
                </div>
              ))}
            </div>
          </div>
