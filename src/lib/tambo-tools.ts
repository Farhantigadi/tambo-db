...
export const tamboTools = [
  {
    ...
    tool: async (params: Record<string, unknown>) => params,
  ...
  },
  {
    ...
    outputSchema: z.object({ success: z.boolean(), deals: z.array(z.record(z.unknown())).optional(), error: z.string().optional() }),
  },
  {
    name: 'assign_contact',
  ...
  },
  {
    ...
    outputSchema: z.object({ success: z.boolean(), forecast: z.record(z.unknown()).optional(), error: z.string().optional() }),
  },
];
